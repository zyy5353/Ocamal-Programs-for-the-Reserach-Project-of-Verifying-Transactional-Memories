...
This folder includes the automomata models implemented for the paper [[3]](#references) [*Verifying-Safety-and-Liveness-for-the-FlexTM-Hybrid-Transactional-Memory*](http://user.it.uu.se/~yunzh803/date_2013.pdf) published at the conference [DATE 2013](https://www.date-conference.com/date13/) (author names are ordered alphabetically). The models were implemented with with the functional programming language [Ocaml](https://ocaml.org/learn/description.html). 
